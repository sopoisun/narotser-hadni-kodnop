...
use App\Jobs\JobMutasiProduk;
use Carbon\Carbon;
use Log;
use Validator;

class MutasiProduk extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'mutasi:produk {tanggal?} {to_tanggal?}';
     ...
     * @var string
     */
    protected $description = 'Menghitung mutasi produk.';
    ...
    public function actionNow()
    {
        ...
        $this->info("Hitung mutasi produk tanggal ".$tanggal->format('d M Y'));
        dispatch(new JobMutasiProduk($tanggal->format('Y-m-d')));
    }
    ...
    public function actionRange($tanggal, $to_tanggal)
    {
        ...
        $this->info("Hitung mutasi produk dari tanggal ".$tanggal->format('d M Y').' s/d '.$to_tanggal->format('d M Y'));
        ...
        foreach( $dates as $date ) {
            dispatch(new JobMutasiProduk($date->format('Y-m-d')));
        }
    }
}
