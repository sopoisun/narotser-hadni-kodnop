...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title">
            Daftar Transaksi<small>Laporan {{ $tanggal->format('d M Y') }}</small>
        </h3>
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0)">Transaksi {{ $tanggal->format('d M Y') }}</a></li>
        </ul>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-comments"></i>Daftar Transaksi / Order Tanggal {{ $tanggal->format('d M Y') }}</div>
                <div class="tools">
                    <a href="javascript:;" class="collapse"></a>
                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                    <a href="javascript:;" class="reload"></a>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @else
                            <tr>
                                <td colspan="13" style="text-align:center;">No Data Here</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
