...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title">
            Change Order <small>Atur Order Pelanggan</small>
        </h3>
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0)">Change Order Pelanggan</a></li>
        </ul>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-asterisk"></i>Form Change Order</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                {!! Form::open(['role' => 'form', 'class' => 'form-horizontal', 'id' => 'formOrder']) !!}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @if($errors->has('tanggal')) has-error @endif">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        {{ Form::text('tanggal', $tanggal, ['class' => 'form-control tanggalan', 'id' => 'tanggal', 'data-date-format' => 'yyyy-mm-dd', 'disabled' => 'disabled']) }}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{ Form::text('karyawan', $order->karyawan->nama, ['class' => 'form-control', 'id' => 'karyawan', 'readonly' => 'readonly']) }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-md-offset-3 col-md-9">
                                    <button type="submit" class="btn red" id="btnSaveOrder">Simpan Order</button>
...
<ul  class="nav nav-tabs">
    <li class="active"><a href="#tab_new_order" data-toggle="tab">Order Baru</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-tasks"></i>Daftar Produk Yang Akan Dipesan</div>
                        <div class="tools">
                            <a href="javascript:;" class="collapse"></a>
                            <a href="#portlet-config" data-toggle="modal" class="config"></a>
                            <a href="javascript:;" class="reload"></a>
...
<script>
    /* Detail produk *
    HitungTotalDetail();
    $(document).on('click', '.btn-del-order-detail', function(e){
        if( confirm('Yakin hapus ?') ){
            idRow = $(this).data('id');
            $.ajax({
                url:    "{{ url('/ajax/order/detail/remove') }}",
                type:   "POST",
                data:   { id: idRow, _token: "{{ csrf_token() }}" },
                success: function(res){
                    if( $("#tblDetailOrder tbody tr").length == 2 ){
                        $("#tblDetailOrder tbody").empty();
                    }else{
                        $("#row_detail_order_"+idRow).remove();
                    }

                    HitungTotalDetail();
                    reNumberingRowDetail();
                }
            });
        }
        e.preventDefault();
    ...
    function HitungTotalDetail(){
        var total = 0;
        $("#tblDetailOrder tbody tr").not(':last').each(function(){
    ...
    function reNumberingRowDetail(){
        $("#tblDetailOrder tbody tr").not(':last').each(function(i){
