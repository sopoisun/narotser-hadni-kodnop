        ...
        <ul class="page-breadcrumb breadcrumb">
            <li class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="{{ url('/produk/qty-warning-print') }}" onClick="return sendSession(this)">Print</a></li>
                </ul>
            </li>
            <li>
                <i class="icon-home"></i>
            ...
            <li><a href="javascript:void(0)">Daftar stok produk dibawah qty warning</a></li>
        </ul>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-comments"></i>Daftar stok produk dibawah qty warning</div>
                <div class="tools">
...
<script>
    ...
    function sendSession(_this){
        ...
        var tbody = $("#produk-stok").find('table').find('tbody');
        ...
        if( !print ){
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('/') }}/bahan-produk/qty-warning-session",
