...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title">
            Produk <small>Tambah Produk</small>
        </h3>
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0)">Tambah Produk</a></li>
        </ul>
    ...
    <div class="col-md-6">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                {!! Form::open(['role' => 'form', 'class' => 'form-horizontal', 'id' => 'formproduk']) !!}
                    <div class="form-body">
                            ...
                            <div class="col-md-offset-3 col-md-8">
                                <div class="checkbox-list">
                                    <label class="checkbox-inline">
                                        {{ Form::checkbox('konsinyasi', 'Ya', false, ['id' => 'konsinyasi']) }} Konsinyasi
                                    </label>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    @if( old('produk_details') && count(json_decode(old('produk_details'))) )
        var oldData = {!! old('produk_details') !!};
    ...
    function setPluginRowComponents(currentRow, oldData){
        ...
        currentRow.find('td:eq(1)').find('input').select2({
            ...
            initSelection: function(element, callback) {
                ...
                if (id !== "") {
                    ...
                    row.find('td:eq(5)').text(oldData.subtotal);
                    var selected = {
                        id: oldData.bahan_id,
                        nama: oldData.bahan_text
                    };
