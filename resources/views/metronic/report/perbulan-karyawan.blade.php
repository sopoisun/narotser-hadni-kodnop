...
<div class="row">
    <div class="col-md-12">
        ...
        <h3 class="page-title">
            Laporan Penjualan Karyawan<small>Laporan {{ $tanggal->format('M Y') }}</small>
        </h3>
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0)">Laporan Karyawan {{ $tanggal->format('M Y') }}</a></li>
        </ul>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-comments"></i>Daftar Penjualan Karyawan {{ $tanggal->format('M Y') }}</div>
                <div class="tools">
                    <a href="javascript:;" class="collapse"></a>
                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                    <a href="javascript:;" class="reload"></a>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/report/pertanggal/karyawan/detail?bulan='.$tanggal->format('Y-m').'&karyawan_id='.$karyawan->id) }}" data-toggle="modal"
