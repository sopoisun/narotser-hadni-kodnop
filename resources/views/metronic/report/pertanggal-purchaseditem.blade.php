...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0)">Laporan Produk Dibeli {{ $tanggal->format('d M Y') }}</a></li>
        </ul>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a href="{{ url('/report/pertanggal/purchaseditem/produk-print?tanggal='.$tanggal->format('Y-m-d')) }}"
