...
<div class="row">
    <div class="col-md-12">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li><a href="javascript:void(0)">Pertanggal</a></li>
        </ul>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box yellow">
            <div class="portlet-title">
                <div class="caption"><i class="icon-filter"></i>Filter Periode Tanggal</div>
                <div class="tools">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        {{
                                            Form::select('type',
                                                [
                                                    'sale:count' => 'Penjualan', 'purchase:count' => 'Pembelian',
                                                    'mutasi:bahan' => 'Mutasi Bahan', 'mutasi:produk' => 'Mutasi Produk',
                                                ],
